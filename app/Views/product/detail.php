...
<div class="py-1.5 w-full">
    ...
    <div class="flex flex-col gap-4 border-2 rounded-2xl p-8 w-full">
        <div>
            ...
            <img src="data:image/jpg;base64,<?= base64_encode($product->gambar_baju) ?>"
                class="h-56 w-52 object-cover rounded-xl" alt="product">
        </div>
        <div>
                ...
                <form action="/produk/stok_produk_baru" method="post" id="form-new-size-stock"
                    ...
                    <div class="form-control ">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" name="product-stock" placeholder="10XX" class="input input-bordered"
                                required />
