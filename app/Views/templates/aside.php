...
<div class="pr-14">
    <button type="button" class="aside-btn btn btn-square btn-ghost">
        <img src="<?= base_url('./images/menu.png') ?>" class="w-7" alt="back">
    </button>
</div>
<div id="aside" class="absolute right-full transition-all top-0 z-20 w-fit p-14 bg-white text-right h-screen border-r-2">
